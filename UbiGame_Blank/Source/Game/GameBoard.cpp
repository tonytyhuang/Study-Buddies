...
init(false), px(150), py(150), hapwidth(416.f), haplength(32.f), pastHappiness(1.f),
m_player(nullptr), pet(nullptr), check{ false }, checklist{ nullptr }, happinessTime(30.f), happiness(0.8f)
{
	CreateBackground();
